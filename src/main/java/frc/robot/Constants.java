...
public final class Constants {
  ...
  public static double shootAlgaeDriveSpeed = 2.5; // max 5.81 m/s
...
public static class Vision {
        ...
        static {
          ...
          reefLevelOffsetsMap.put(ReefLevel.L2, new Transform2d(Units.inchesToMeters(25.0), 0, new Rotation2d(Math.toRadians(180))));
          reefLevelOffsetsMap.put(ReefLevel.L3, new Transform2d(Units.inchesToMeters(22.5), 0, new Rotation2d(Math.toRadians(180))));
          reefLevelOffsetsMap.put(ReefLevel.L4, new Transform2d(Units.inchesToMeters(23.0), 0, new Rotation2d(Math.toRadians(180))));
...
public static class BucketConstants {
  ...
  public static final int timesForBucketToTestPositive = 3; // number of consecutive loops a reading must be within detected coral/algae distance in order to test positive
  ...
  public static class ArmSetpoints {
    ...
    public static final Translation2d home = new Translation2d(8.0, 11.3);//new Translation2d(15.65, Rotation2d.fromDegrees(60)); //safest home and also closest possible distance arm is allowed to get to central joint
    ...
    static{
      ...
      Translation2d gripperOffset = new Translation2d(5.9, -2.0);
      ...
      armSetPoints[2] = new ArmPoint(new Translation2d(-13.7, 28.0), Units.degreesToRadians(180 + 105));//new ArmPoint(new Translation2d(-8.6, 20.1), Units.degreesToRadians(180 + 145)).add(new Translation2d(dropoffDistanceFromBumper, 0)).withGripperOffset(gripperCoralOffsetInverted);
      ...
      armSetPoints[4] = new ArmPoint(new Translation2d(ArmConstants.totalStageLength, Rotation2d.fromDegrees(106)), Units.degreesToRadians(126));//new ArmPoint(new Translation2d(-8.4, 49.9), Units.degreesToRadians(150)).add(new Translation2d(dropoffDistanceFromBumper, 0)).withGripperOffset(gripperCoralOffset);
      armSetPoints[1] = armSetPoints[4];

      armSetPoints[5] = new ArmPoint(new Translation2d(-13.4, 20.0), Units.degreesToRadians(170)).add(new Translation2d(dropoffDistanceFromBumper, 0)).withGripperOffset(gripperAlgaeOffset);
      armSetPoints[6] = new ArmPoint(new Translation2d(-13.4, 41.0), Units.degreesToRadians(170)).add(new Translation2d(dropoffDistanceFromBumper, 0)).withGripperOffset(gripperAlgaeOffset);
      ...
      armSetPoints[13] = new ArmPoint(home.rotateBy(Rotation2d.fromDegrees(30)), Units.degreesToRadians(200));
     ...
     * @L4 4 
     */
    public static ArmPoint[] armSetPointsDunkAuto = new ArmPoint[5]; // autodunks
    static {
      armSetPointsDunkAuto[0] = armSetPoints[0];
      armSetPointsDunkAuto[1] = armSetPoints[1];
      armSetPointsDunkAuto[2] = armSetPoints[2].addToWristFlip(Units.degreesToRadians(-60)).add(new Translation2d(-9, new Rotation2d(armSetPoints[2].wrist + (Math.PI*0.5))));
      armSetPointsDunkAuto[3] = armSetPoints[3].add(new Translation2d(-3, new Rotation2d(armSetPoints[3].wrist - (Math.PI*0.5)))).addToWristFlip(Units.degreesToRadians(45));
      armSetPointsDunkAuto[4] = armSetPoints[4].addToWristFlip(Units.degreesToRadians(60)).add(new Translation2d(-3, -4));
    }
    public static ArmPoint[] armSetPointsMicroAdjust = new ArmPoint[5]; // manual dunks
    static {
      armSetPointsMicroAdjust[0] = armSetPoints[0];
      armSetPointsMicroAdjust[1] = armSetPoints[1];
      armSetPointsMicroAdjust[2] = armSetPoints[2].add(new Translation2d(0, -5));
      armSetPointsMicroAdjust[3] = armSetPoints[3].add(new Translation2d(-9, new Rotation2d(armSetPoints[3].wrist - (Math.PI*0.3)))).addToWristFlip(Units.degreesToRadians(45));
      armSetPointsMicroAdjust[4] = armSetPoints[4].addToWristFlip(Units.degreesToRadians(60));
