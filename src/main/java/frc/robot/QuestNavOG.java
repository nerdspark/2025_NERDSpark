...
public class QuestNavOG {
  ...
  private Pose2d resetPosition = new Pose2d(inchesToMeters(-26.375), inchesToMeters(-64.5), new Rotation2d()); //-0.42545, -1.651
  ...
  public Pose2d getPose() {
    ...
    SmartDashboard.putData("QuestNavOG", field);
  ...
  private Pose2d getQuestNavPose() {
    var oculousPositionCompensated = getQuestNavTranslation().rotateAround(getQuestNavTranslation().plus(new Translation2d(inchesToMeters(-12.625), 0)), Rotation2d.fromDegrees(getOculusYaw()));
