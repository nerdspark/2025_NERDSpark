...
public class ArmCommandGripperFunnelPickup extends Command {
  private Gripper gripper;
  private double timeToAct = Timer.getFPGATimestamp();
  /** Creates a new ArmCommandGripperAutoClose. */
  public ArmCommandGripperFunnelPickup(Gripper gripper) {
  ...
  public boolean isFinished() {
    return Math.abs(timeToAct - Timer.getFPGATimestamp()) > 0.12 && gripper.getFunnelDetected();
  }
}
