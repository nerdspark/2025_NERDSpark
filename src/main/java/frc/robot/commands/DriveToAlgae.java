...
private final ProfiledPIDController driveController =
      new ProfiledPIDController(
          0.2, 0, 0, new TrapezoidProfile.Constraints(0.5,Constants.Vision.MAX_ACCELARATION), loopPeriodSecs); //10, 0, 0
  private final ProfiledPIDController thetaController =
      new ProfiledPIDController(
 ...
 private double driveErrorAbs;
  ...
  public DriveToAlgae(CommandSwerveDrivetrain drive, Supplier<Pose2d> poseSupplier) {
    this.drive = drive;
  ...
  public void initialize() {
    ...
    Constants.Vision.kAlgaeTargeted = true;
  ...
  public void execute() {
    ...
    if (currentDistance > 0.5) driveVelocityScalar = -2.0;
  ...
  public void end(boolean interrupted) {
    running = false;
    Constants.Vision.kAlgaeTargeted = false;
    //Constants.Vision.kAlgaeAutoTarget = false;
  ...
  public boolean isRunning() {
    ...
    public boolean isFinished() {
        return this.atGoal();// || !Constants.Vision.kAlgaeAutoTarget;
    }
